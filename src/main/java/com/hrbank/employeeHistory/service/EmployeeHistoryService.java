package com.hrbank.employeeHistory.service;
...
public class EmployeeHistoryService {
    ...
    public void createUpdateHistory(Employee employee, String memo) {
        ...
        List<EmployeeHistory> changes = new ArrayList<>();
    ...
    //필드 비교 및 추가 로직
    private void compareAndAdd(List<EmployeeHistory> list,
                               Employee employee,
                               String beforeValue,
                               String afterValue,
                               String field,
        ...
        if (!Objects.equals(beforeValue, afterValue)) {
            list.add(EmployeeHistory.builder()
                    .employee(employee)
